...
**指标：** `task_success_rate`、`tool_call_rate`、`verification_rate`、`no_tool_final_rate`、`memory_interference_rate`、`tokens_per_successful_task`、`compaction_saved_tokens` 等。
