...
规格权威：[`docs/双模方案2.md`](./双模方案2.md) · 手工手册：[`docs/test.md`](./test.md) · 流程图：[`docs/双模 L2 流程图.md`](./双模%20L2%20流程图.md)
...
**[`docs/环境变量.md`](./环境变量.md)**（英文精简版：[`docs/environment-variables.md`](./environment-variables.md)）
...
- [`docs/environment-variables.md`](./environment-variables.md) — Environment variables (English)
...
- [`docs/test.md`](./test.md) — **双模完整测试手册**（1165 自动化 + 15 项 Web 手工场景）
...
- [`docs/locomo/memory-optimization-roadmap.md`](./locomo/memory-optimization-roadmap.md) — 记忆 benchmark 与召回优化
